...
import { BaseSignerWalletAdapter, WalletConnectionError, WalletDisconnectedError, WalletDisconnectionError, WalletLoadError, WalletNotConnectedError, WalletNotReadyError, WalletPublicKeyError, WalletSignTransactionError, } from '@solana/wallet-adapter-base';
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let TransportWebHID;
                try {
                    TransportWebHID = yield import('@ledgerhq/hw-transport-webhid');
                }
                catch (error) {
                ...
                let transport;
                try {
                    transport = yield TransportWebHID.default.create();
                }
                catch (error) {
